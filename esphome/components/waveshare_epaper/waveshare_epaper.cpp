...
static const uint8_t LUT_SIZE_2P9_B2 = 159;

static const uint8_t FULL_UPDATE_LUT_2P9_V2[LUT_SIZE_2P9_B2] = {
...
static const uint8_t PARTIAL_UPDATE_LUT_2P9_V2[LUT_SIZE_2P9_B2] = {
    ...
    if (full_update != prev_full_update) {
      switch (this->model_) {
        ...
        case TTGO_EPAPER_2_13_IN_B1:
          ...
          break;
        case WAVESHARE_EPAPER_2_9_IN_V2:
          this->write_lut_(full_update ? FULL_UPDATE_LUT_2P9_V2 : PARTIAL_UPDATE_LUT_2P9_V2, LUT_SIZE_2P9_B2);
        default:
